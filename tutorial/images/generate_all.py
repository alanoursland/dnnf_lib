...
graphviz binary required (layouts come from modenexus.viz.layered_layout).
"""
...
from modenexus.circuit import AND, LIT, OR
from modenexus.viz import layered_layout, node_label
...
def img_04a(system):
    ...
    count_vals = []
    from modenexus.eval import _forward
